...
export default function AboutSection() {
  ...
  // Animation Variants (Recreated from your custom components)
  const revealUp = {
  ...
  // Text for the Vertical Cut Reveal
 ...
 const wordAnimation = {
  ...
  return (
    <section className="relative py-32 px-4 bg-black-50 overflow-hidden" ref={containerRef}>
      ...
      {/* ---------------- SVG CLIP PATHS (DON'T TOUCH THESE) ---------------- */}
      ...
      <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
        ...
        {/* Label */}
        <motion.div 
          variants={fadeIn} initial="hidden" animate={isInView ? 'visible' : 'hidden'} custom={3}
          className="text-blue-600 text-lg font-semibold uppercase mb-6 flex items-center justify-center gap-2"
        >
    ...
    >
      {word}
        ...
        <motion.p
          ...
          animate={isInView ? 'visible' : 'hidden'}
          custom={4}
          className="text-gray-600 text-center sm:text-lg text-sm mb-8 leading-relaxed max-w-xl mx-auto"
        >
          ForecastX is a modern weather experience designed to deliver real-time forecasts with speed, precision, and a clean user interface. Built using React, Next.js, and live weather APIs, it combines accurate weather data with premium animations to create an experience that is both informative and visually engaging.
        </motion.p>

       
      </div>

      {/* ---------------- IMAGE GRID WITH CUSTOM SVGS ---------------- */}
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-4 gap-4 pt-20 lg:h-104 md:h-88 sm:h-64 h-56">
